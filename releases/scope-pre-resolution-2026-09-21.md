# Scope — pre-resolution draft

**Status:** frozen historical draft · **Originally declared:** 2026-08-10 · **Superseded:** 2026-09-22

This is the frozen scope that existed before the booking and phone contract was resolved. It is retained for history and is not the current v1 offer. The authoritative scope is `out/scope.md`.
...
|---|---|---|
| Pre-resolution draft | 2026-08-10 | frozen — this file |
